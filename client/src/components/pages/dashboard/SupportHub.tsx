...
const SupportHub: React.FC = () => {
  ...
  return (
    <div id="supportHub" className="min-h-screen p-4 sm:p-6 lg:p-8">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Support Hub</h1>
        <p className="text-gray-600 text-sm sm:text-base">Get assistance and find answers to your questions</p>
      </div>

      {/* Quick Help Banner */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl overflow-hidden shadow-lg mb-8">
        <div className="flex flex-col md:flex-row">
          <div className="p-6 md:w-2/3 text-white relative z-10">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-2">How Can We Assist You Today?</h2>
            <p className="mb-4 text-sm sm:text-base">Our support team is here to help you have the best possible event experience.</p>
            <div className="relative max-w-md">
              <input
                type="text"
                placeholder="Search for help..."
                className="w-full py-3 px-4 pr-10 rounded-lg border-0 focus:ring-2 focus:ring-white/50 bg-white/10 backdrop-blur-sm text-white placeholder-white/70 text-sm sm:text-base"
              />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {quickSupportOptions.map((option, index) => (
          <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition duration-200 p-5">
            <div className="flex flex-col items-center text-center">
              <div className={`w-14 h-14 rounded-full bg-${option.color}-100 flex items-center justify-center mb-4`}>
                {option.icon}
              </div>
              <h3 className="text-lg font-medium text-gray-800 mb-2">{option.title}</h3>
              <p className="text-gray-600 text-sm mb-4">{option.description}</p>
              <button className={`inline-flex items-center px-4 py-2 bg-${option.color}-600 text-white rounded-lg text-sm font-medium hover:bg-${option.color}-700 transition duration-200 mt-auto`}>
                {option.buttonText}
              </button>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-8 overflow-hidden">
        <div className="border-b border-gray-100 p-4 bg-gradient-to-r from-indigo-50 to-blue-50">
          ...
          {faqItems.map((faq, index) => (
            <div key={index} className="p-4 hover:bg-gray-50">
              <button className="flex w-full justify-between items-center text-left">
                <h3 className="font-medium text-gray-800 text-sm sm:text-base">{faq.question}</h3>
      ...
      {/* Support Categories */}
      <div className="mb-8">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Support Categories</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {supportCategories.map((category, index) => (
            <div key={index} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition duration-200">
              <div className={`p-4 border-b border-gray-100 bg-gradient-to-r ${category.gradient}`}>
              ...
              <div className="p-4">
                <ul className="space-y-2">
                  {category.items.map((item, i) => (
                    <li key={i}>
                      <a href="#" className="flex items-center text-gray-700 hover:text-indigo-600 transition duration-200 text-sm sm:text-base">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="flex items-center p-4 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-blue-50">
            <div className="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center mr-3">
              <svg className="w-5 h-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
            </div>
            <h3 className="font-medium text-gray-800 text-sm sm:text-base">Live Chat with Support</h3>
          </div>
          <div className="p-4">
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <div className="flex items-start mb-3">
                ...
                <div className="bg-white p-3 rounded-lg rounded-tl-none shadow-sm max-w-xs">
                  <p className="text-sm text-gray-800">Hello! How can I help you today with the event?</p>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent pr-12 text-sm sm:text-base"
              />
        ...
        {/* Contact Information */}
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="flex items-center p-4 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-pink-50">
            <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center mr-3">
              <svg className="w-5 h-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
            </div>
            <h3 className="font-medium text-gray-800 text-sm sm:text-base">Contact Information</h3>
          </div>
          <div className="p-4">
            <div className="space-y-4">
              {contactInfo.map((info, index) => (
                <div key={index} className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-800">{info.title}</h4>
                    <p className="text-gray-600 text-sm sm:text-base whitespace-pre-line">{info.content}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* Contact Form */}
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-8 overflow-hidden">
        <div className="border-b border-gray-100 p-4 bg-gradient-to-r from-green-50 to-teal-50">
        ...
        <div className="p-5">
          <form>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm sm:text-base"
                />
              </div>
              <div>
            ...
            <div>
              <button
                type="submit"
                className="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-medium transition duration-200"
              >
                Send Message
              </button>
            </div>
      ...
      {/* Support Team */}
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl overflow-hidden shadow-lg mb-6 text-white relative">
        <div className="p-6">
          <h2 className="text-xl font-bold mb-4">Meet Our Support Team</h2>
          <p className="text-indigo-100 mb-6 text-sm sm:text-base">Our team of experienced professionals is here to make your event experience seamless and enjoyable.</p>
