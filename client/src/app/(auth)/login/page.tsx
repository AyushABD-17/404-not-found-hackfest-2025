...
import { useLoginMutation, useRegisterMutation } from "@/app/redux/features/auth/authApi";
...
const Page = (props: Props) => {
  ...
  const handleGoogleSignin = () => {
    ...
    document.cookie = `redirectTo=${redirectTo}; path=/; samesite=none; secure`;
  ...
  return (
    <div className="min-h-screen max-w-screen-xl mx-auto flex justify-center items-center">
      <div className="max-w-[420px] dark:bg-[#131920] bg-slate-100 rounded-xl p-10 w-full ">
        <h1>Sign in to EventSentiment</h1>
